...
INSERT INTO `qa_posts` (`id`, `user_id`, `title`, `slug`, `content`, `status`, `parent_id`, `type`, `mode`, `up_vote_count`, `down_vote_count`, `view_count`, `answer_count`, `comment_count`, `favorite_count`, `last_activity_date`, `date_created`, `created_by`, `date_modified`, `modified_by`, `is_deleted`) VALUES
...
(2, 'benson@test.com', 'benson', '174629a11fb64cfd8c822e7283a1c9af5288687b2097fa1cb9', 2, 1267361657, '', 'Benson Harper', '', '0000-00-00', '', 'sg9mb9bulhnnvmnd7ldskpvt94mtedya', '2010-02-27 14:42:33', '127.0.0.1', 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-GB; rv:1.9.1.8) Gecko/20100202 Firefox/3.5.8 GTB6', 0, 2, 2, 0, 0, 0, 0, 0, 0, 1, 0, '2010-02-27 14:42:33', 'user::create_user', '2010-02-27 14:46:58', 'post::create_question', 0),
